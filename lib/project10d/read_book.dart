    ...
    return Scaffold(
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(image: NetworkImage('https://i2.wp.com/greatstorybook.com/wp-content/uploads/2014/09/worstwitch.jpg?resize=191%2C263',),fit: BoxFit.cover),),
              child:
                Padding(
...
Padding(
  ...
  Column(
    children: const [
      Padding(
        padding: EdgeInsets.all(8.0),
        child: Text('mike hussey',style: TextStyle(fontSize: 20),),
      ),
      Text('1890  2016',style: TextStyle(fontSize: 15),),
    ],
  )
...
const Padding(
  ...
  child:   Text('Reviews',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
       ...
       Padding(
         padding: const EdgeInsets.all(8.0),
         child: Row(children: [
           CircleAvatar(child: Image.asset('assets/img_7.png',height: 50),),
           Column(children: [
             ...
             RatingBar.builder(
               ...
               onRatingUpdate: (rating) {
                ...
                const Padding(
                  ...
                  child: Text('for above i love this bokk tittle and conclsion of the bokk,',style: TextStyle(fontSize: 20),
                  ),
                ),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Row(children: [
                    CircleAvatar(child: Image.asset('assets/img_6.png',height: 60),),
                    Column(children: [
                      const Text('maria '),
                      RatingBar.builder(
                        initialRating: 3,
                ...
                const Padding(
                  padding: EdgeInsets.only(left: 10),
                  child: Text('I want this book rating 5 star but i couldnot,there is some '
                      ...
                      'on the conclusion it gave advantage to me .',style: TextStyle(fontSize: 20),),
                ),
